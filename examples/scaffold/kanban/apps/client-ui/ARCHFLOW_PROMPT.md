...
## Internal Workflows
- $Task_Interaction: state:Viewing_Board >> action:Submit_New_Task >> action:Render_Task_List >> state:Board_Updated >> state:Viewing_Board >> action:Request_Task_Delete >> action:Render_Task_List >> state:Board_Updated
